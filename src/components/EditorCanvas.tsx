...
export default function EditorCanvas({
  ...
  const drawGrid = useCallback(() => {
    ...
    ctx.stroke();
    ctx.shadowBlur = 0;
  }, [projectData, gridZoom, selectedNoteIds, selectionBox, hoverPreview, selectedNoteType, noteWidth, canvasRef, containerRef, stateRef, timeDisplayRef, progressBarRef, isDraggingProgress, audioRef]);
